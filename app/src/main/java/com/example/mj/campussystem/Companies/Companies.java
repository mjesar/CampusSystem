...
public class Companies extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_signout) {
            ...
            Intent intent = new Intent(Companies.this, SignIn.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_company_profile) {
            fragmentManager.beginTransaction()
                    .replace(R.id.frame_layout, new CompaniesProfileFragment())
                    .commit();
        } else if (id == R.id.nav_post_job) {
            fragmentManager.beginTransaction()
                    .replace(R.id.frame_layout, new CompaniesPostJobFragment())
                    .commit();
        } else if (id == R.id.nav_students) {
            fragmentManager.beginTransaction()
                    .replace(R.id.frame_layout, new CompanyStudentsFragment())
                    .commit();
        } else if (id == R.id.nav_requests) {
            fragmentManager.beginTransaction()
                    .replace(R.id.frame_layout, new CompaniesJobRequestFragment())
                    .commit();
        }
