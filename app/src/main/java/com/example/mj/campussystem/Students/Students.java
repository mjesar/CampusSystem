...
public class Students extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_signout) {
            ...
            Intent intent = new Intent(Students.this, SignIn.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_students_profile) {
            fragmentManager.beginTransaction()
                    .replace(R.id.frame_layout, new StudentProfileFragment())
                    .commit();
        } else if (id == R.id.nav_students_jobs) {
            fragmentManager.beginTransaction()
                    .replace(R.id.frame_layout, new StudentJobFragment())
                    .commit();
        } else if (id == R.id.nav_students_companies) {
            fragmentManager.beginTransaction()
                    .replace(R.id.frame_layout, new StudentsCompaniesFragments())
                    .commit();
        }
